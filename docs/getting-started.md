...
Basic usage
-----------
Creates a DANS OpenAPI definition module. This module contains the OpenAPI definition of a DANS API. The `generate-dans-api.sh` script will interactively query
you for argument values.
